...
const SignupSchema = z
  .object({
    ...
    weekPregnancy: z
      .number()
      .min(1, "A semana de gravidez deve ser maior ou igual a 1.")
      .max(40, "A semana de gravidez não pode ser maior que 40."),
  })
  .refine((data) => data.password === data.confirmPassword, {
    message:
      "As senhas fornecidas não estão iguais, favor confira e tente novamente.",
  ...
  const submitSignup = async () => {
    try {
      ...
      const weekPregnancyNumber =
        weekPregnancy && weekPregnancy.trim() !== ""
          ? Number(weekPregnancy)
          : NaN;
